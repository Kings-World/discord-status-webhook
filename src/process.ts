...
export const createAndSendStatus = (incident: IncidentSchemaType) =>
	Effect.gen(function* () {
	...
	}).pipe(Effect.withLogSpan("createAndSendStatus"));
...
export const updateStatus = (
	...
	}).pipe(Effect.withLogSpan("updateStatus"));

export const isResolvedStatus = (status: IncidentStatusType) =>
	status === "postmortem" || status === "resolved";

export const processIncident = (incident: IncidentSchemaType) =>
	Effect.gen(function* () {
		const drizzle = yield* Drizzle;
	...
	}).pipe(Effect.withLogSpan("processIncident"));
