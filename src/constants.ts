...
export const incidentsJsonUrl = "https://srhpyqt94yxb.statuspage.io/api/v2/incidents.json";

export const logger = new Logger({ level: LogLevel.Debug });

export const statusData: Record<z.infer<typeof incidentStatusEnum> | string, [color: number, emoji: string]> = {
...
export const roleId = envIsDefined("ROLE_ID") ? envParseString("ROLE_ID") : null;
